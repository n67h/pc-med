<?php
    ...
    function createUser($conn, $email, $firstname, $lastname, $phone, $address, $password, $role, $vkey, $verified) {

        $sql = "INSERT INTO users (email, f_name, l_name, phone_no, address, password, user_role_id, verification_key, is_verified) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);";
        ...
        mysqli_stmt_bind_param($stmt, "ssssssisi", $email, $firstname, $lastname, $phone, $address, $hashedPassword, $role, $vkey, $verified);
