...
<div class="maindrop">  
        <ul class="dropdown">
            <h4 style="display: none;"><ion-icon name="filter-circle-outline"></ion-icon>Categories</i></h4>
            <div class="list1">
                <ul>
                    <?php
             ...
             <ul class="dropdown">
            <h4 class="accounts-dropdown"><ion-icon name="person-circle-outline"></ion-icon>Account</i></h4>
            <div class="list1">
            <ul>          
                <?php
                    if(isset($_SESSION['id'])){
                        ...
                        echo '<li><a href="profile.php">' .$f_name. ' ' .$l_name. '</a></li>';
                        echo '<li><a href="order-transactions.php">My orders</a></li>';
                    } else {
